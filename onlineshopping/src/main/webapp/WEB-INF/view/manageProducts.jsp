			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<sf:form id="mForm" action = "${SITE_URL}/manage/category/save" method = "POST" modelAttribute="cate">
							<div class="form-group">
								<label class="label-control">Category Name</label>
								<sf:input type="text" path="name"  id="cname" class="form-control"/>
								
							</div>
							<div class="form-group">
								<label class="label-control">Description</label>
								<sf:textarea rows="8" cols="55" path="description"  id="cdescription"  class="form-control" />
